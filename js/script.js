...
const backgrounds = {
  alaska: 'assets/background/alaska.png',
  alberta: 'assets/background/alberta.png',
  atlanta: 'assets/background/atlanta.png',
  baghdad: 'assets/background/baghdad.png',
  boston: 'assets/background/boston.png',
  bullseye: 'assets/background/bullseye.png',
  cambodia: 'assets/background/cambodia.png',
  capetown: 'assets/background/capetown.png',
  carolina: 'assets/background/carolina.png',
  ceko: 'assets/background/ceko.png',
  china: 'assets/background/china.png',
  gaza: 'assets/background/gaza.png',
  hongkong: 'assets/background/hongkong.png',
  jakarta: 'assets/background/jakarta.png',
  japan: 'assets/background/japan.png',
  kairo: 'assets/background/kairo.png',
  kanada: 'assets/background/kanada.png',
  kanagawa: 'assets/background/kanagawa.png',
  kazan: 'assets/background/kazan.png',
  kentucky: 'assets/background/kentucky.png',
  kkmalam: 'assets/background/kkmalam.png',
  kksore: 'assets/background/kksore.png',
  norwegia: 'assets/background/norwegia.png',
  nusa: 'assets/background/nusa.png',
  oregon12: 'assets/background/oregon12.png',
  oregon9: 'assets/background/oregon9.png',
  oregon6: 'assets/background/oregon6.png',
  oregon3: 'assets/background/oregon3.png',
  pcso: 'assets/background/pcso.png',
  porto: 'assets/background/porto.png',
  pyongyang: 'assets/background/pyongyang.png',
  singapore: 'assets/background/singapore.png',
  sydney: 'assets/background/sydney.png',
  taiwan: 'assets/background/taiwan.png',
  '4d6': 'assets/background/4d6.png',
  '4d5': 'assets/background/4d5.png',
  '4d4': 'assets/background/4d4.png',
  '4d3': 'assets/background/4d3.png',
  '4d2': 'assets/background/4d2.png',
  '4d1': 'assets/background/4d1.png',
  '5dmalam': 'assets/background/5dmalam.png',
  '5dsore': 'assets/background/5dsore.png',
  venice: 'assets/background/venice.png',
  verona: 'assets/background/verona.png',
  virginia: 'assets/background/virginia.png',
  washington: 'assets/background/washington.png'
};
